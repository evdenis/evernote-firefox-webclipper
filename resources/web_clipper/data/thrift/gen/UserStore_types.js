...
BootstrapSettings = function(args) {
  ...
  if (args) {
    ...
    if (args.cardscanUrl !== undefined) {
      this.cardscanUrl = args.cardscanUrl;
    }
    if (args.announcementsUrl !== undefined) {
      this.announcementsUrl = args.announcementsUrl;
    }
...
BootstrapSettings.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 14:
      if (ftype == Thrift.Type.STRING) {
        this.cardscanUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 15:
      if (ftype == Thrift.Type.STRING) {
        this.announcementsUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
BootstrapSettings.prototype.write = function(output) {
  ...
  if (this.cardscanUrl !== null && this.cardscanUrl !== undefined) {
    output.writeFieldBegin('cardscanUrl', Thrift.Type.STRING, 14);
    output.writeString(this.cardscanUrl);
    output.writeFieldEnd();
  }
  if (this.announcementsUrl !== null && this.announcementsUrl !== undefined) {
    output.writeFieldBegin('announcementsUrl', Thrift.Type.STRING, 15);
    output.writeString(this.announcementsUrl);
    output.writeFieldEnd();
  }
...
PushNotificationCredentials = function(args) {
  this.iosDeviceToken = null;
  if (args) {
    if (args.iosDeviceToken !== undefined) {
      this.iosDeviceToken = args.iosDeviceToken;
    }
  }
};
PushNotificationCredentials.prototype = {};
PushNotificationCredentials.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.iosDeviceToken = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
...
PushNotificationCredentials.prototype.write = function(output) {
  output.writeStructBegin('PushNotificationCredentials');
  if (this.iosDeviceToken !== null && this.iosDeviceToken !== undefined) {
    output.writeFieldBegin('iosDeviceToken', Thrift.Type.STRING, 1);
    output.writeBinary(this.iosDeviceToken);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
