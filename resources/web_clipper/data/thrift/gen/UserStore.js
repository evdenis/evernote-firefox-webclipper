...
UserStore_registerForSyncPushNotifications_args = function(args) {
  this.authenticationToken = null;
...
UserStore_registerForSyncPushNotifications_args.prototype = {};
UserStore_registerForSyncPushNotifications_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.credentials = new PushNotificationCredentials();
...
UserStore_registerForSyncPushNotifications_args.prototype.write = function(output) {
  output.writeStructBegin('UserStore_registerForSyncPushNotifications_args');
  if (this.authenticationToken !== null && this.authenticationToken !== undefined) {
    output.writeFieldBegin('authenticationToken', Thrift.Type.STRING, 1);
    output.writeString(this.authenticationToken);
    output.writeFieldEnd();
...
UserStore_registerForSyncPushNotifications_result = function(args) {
  this.userException = null;
  this.systemException = null;
  this.notFoundException = null;
  if (args instanceof EDAMUserException) {
...
UserStore_registerForSyncPushNotifications_result.prototype = {};
UserStore_registerForSyncPushNotifications_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
UserStore_registerForSyncPushNotifications_result.prototype.write = function(output) {
  output.writeStructBegin('UserStore_registerForSyncPushNotifications_result');
  if (this.userException !== null && this.userException !== undefined) {
    output.writeFieldBegin('userException', Thrift.Type.STRUCT, 1);
    this.userException.write(output);
    output.writeFieldEnd();
...
UserStore_unregisterForSyncPushNotifications_args = function(args) {
  this.authenticationToken = null;
  if (args) {
    if (args.authenticationToken !== undefined) {
      this.authenticationToken = args.authenticationToken;
...
UserStore_unregisterForSyncPushNotifications_args.prototype = {};
UserStore_unregisterForSyncPushNotifications_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
UserStore_unregisterForSyncPushNotifications_args.prototype.write = function(output) {
  output.writeStructBegin('UserStore_unregisterForSyncPushNotifications_args');
  if (this.authenticationToken !== null && this.authenticationToken !== undefined) {
    output.writeFieldBegin('authenticationToken', Thrift.Type.STRING, 1);
    output.writeString(this.authenticationToken);
    output.writeFieldEnd();
...
UserStore_unregisterForSyncPushNotifications_result = function(args) {
  this.userException = null;
  this.systemException = null;
  this.notFoundException = null;
  if (args instanceof EDAMUserException) {
...
UserStore_unregisterForSyncPushNotifications_result.prototype = {};
UserStore_unregisterForSyncPushNotifications_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
UserStore_unregisterForSyncPushNotifications_result.prototype.write = function(output) {
  output.writeStructBegin('UserStore_unregisterForSyncPushNotifications_result');
  if (this.userException !== null && this.userException !== undefined) {
    output.writeFieldBegin('userException', Thrift.Type.STRUCT, 1);
    this.userException.write(output);
    output.writeFieldEnd();
...
UserStoreClient.prototype.registerForSyncPushNotifications = function(authenticationToken, credentials, callback) {
  if (callback === undefined) {
    this.send_registerForSyncPushNotifications(authenticationToken, credentials);
    this.recv_registerForSyncPushNotifications();
  } else {
    var postData = this.send_registerForSyncPushNotifications(authenticationToken, credentials, true);
    return this.output.getTransport()
      .send(this, postData, arguments, this.recv_registerForSyncPushNotifications);
  }
};

UserStoreClient.prototype.send_registerForSyncPushNotifications = function(authenticationToken, credentials, callback) {
  this.output.writeMessageBegin('registerForSyncPushNotifications', Thrift.MessageType.CALL, this.seqid);
  var args = new UserStore_registerForSyncPushNotifications_args();
  args.authenticationToken = authenticationToken;
...
UserStoreClient.prototype.recv_registerForSyncPushNotifications = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new UserStore_registerForSyncPushNotifications_result();
  result.read(this.input);
  this.input.readMessageEnd();
...
UserStoreClient.prototype.unregisterForSyncPushNotifications = function(authenticationToken, callback) {
  if (callback === undefined) {
    this.send_unregisterForSyncPushNotifications(authenticationToken);
    this.recv_unregisterForSyncPushNotifications();
  } else {
    var postData = this.send_unregisterForSyncPushNotifications(authenticationToken, true);
    return this.output.getTransport()
      .send(this, postData, arguments, this.recv_unregisterForSyncPushNotifications);
  }
};

UserStoreClient.prototype.send_unregisterForSyncPushNotifications = function(authenticationToken, callback) {
  this.output.writeMessageBegin('unregisterForSyncPushNotifications', Thrift.MessageType.CALL, this.seqid);
  var args = new UserStore_unregisterForSyncPushNotifications_args();
  args.authenticationToken = authenticationToken;
  args.write(this.output);
  this.output.writeMessageEnd();
  return this.output.getTransport().flush(callback);
...
UserStoreClient.prototype.recv_unregisterForSyncPushNotifications = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new UserStore_unregisterForSyncPushNotifications_result();
  result.read(this.input);
  this.input.readMessageEnd();
